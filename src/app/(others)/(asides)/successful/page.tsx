...
export default function SuccessfulPage() {
    return (
        <div className="h-screen flex items-center">
            ...
            {/* Background Gradient */}
                <div className="absolute inset-0 bg-gradient-to-tl from-[#1F1F1F] to-[#00ff7b] opacity-90 z-0"></div>
                
                {/* Radial Gradient Circle */}
                <div className="absolute inset-0 flex justify-center items-center z-10">
                    <div className="w-[300px] h-[300px] bg-gradient-radial from-[#b4ffda] to-[#1F1F1F]/10 rounded-full blur-3xl opacity-20"></div>
                </div>
                ...
                <div className="relative z-20 px-6 py-3 rounded-3xl bg-[#1F1F1F]/30 backdrop-blur-lg">
                    ...
                    <div className="py-4">
                        ...
                        <div className="text-sm font-normal text-[#aaa] my-6">
                            <p>Borrow, Lend and Provide Liquidity <br />to others on Kaleido</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-2">
                        <Link href={"/marketplace"} className="cursor-pointer">
                            <Btn
                                text={"Marketplace"}
                                css="text-black bg-[#FF4D00]  text-xl w-full py-6 rounded-[75px] flex items-center justify-center"
                            />
                        </Link>
                    </div>
                </div>
