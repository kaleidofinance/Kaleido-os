  ...
  return (
    <div className={s.row}>
      <div className={s.asset}>
        <span className={s.icon}>{p.label.slice(0, 3)}</span>
        <div>
      ...
      <main className={s.wrap}>
        <div className={s.head}>
          ...
          <div>
            ...
            <div className={s.pnet}>{chainName}</div>
          </div>
        ...
        <div className={s.strip}>
          <div className={s.stat}>
            ...
            <span className={`${s.sVal} tabular`}>{healthText(p.health)}</span>
          </div>
          <div className={s.stat}>
            <span className={s.sLabel}>Collateral</span>
            <span className={`${s.sVal} tabular`}>{usd(p.collateralUsd, 0)}</span>
          </div>
          <div className={s.stat}>
