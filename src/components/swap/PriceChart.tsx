...
export default function PriceChart({ 
  ...
  if (loading && !spotPrice) {
    return (
      <div className={`bg-black/90 backdrop-blur-sm h-[360px] w-full max-w-full rounded-2xl p-3 sm:h-[500px] sm:p-6 shadow-xl text-white relative overflow-hidden border border-[#00ff99]/20 ${className}`}>
