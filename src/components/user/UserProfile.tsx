...
export const UserProfile = ({
  ...
  const handleCopy = useCallback(
    async (text: string, type: "address" | "link") => {
      try {
  ...
  return (
    <div
      className={`relative w-full min-w-0 rounded-xl border border-[#00ff99]/20 bg-[#0f0f1a]/40 p-4 shadow-[0_0_40px_rgba(0,0,0,0.3)] backdrop-blur-xl sm:p-5 ${shareTechMono.className}`}
    >
      {/* Neon Corners */}
      ...
      <div id="user-profile-dropdown" className="space-y-5 sm:space-y-6">
        ...
        <div className="group">
          ...
          <div className="truncate select-all rounded-lg border border-white/5 bg-white/5 p-2 font-mono text-xs text-gray-500 transition-colors group-hover:border-[#00ff99]/10">
            {REFERRAL_LINK}
          </div>
        </div>
      ...
      <div className="mt-6 flex flex-col items-center space-y-3 sm:mt-8">
        {username ? (
          <button
            disabled
        ...
        <Link
          href="https://x.com/kaleido_finance"
          target="_blank"
