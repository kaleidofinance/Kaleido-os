  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-[calc(100vw-24px)] max-w-6xl -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl border border-[#00ff99]/20 bg-black/80 shadow-2xl shadow-black/50 backdrop-blur-md">
          {/* Header */}
          <div className="flex items-start justify-between gap-3 border-b border-[#00ff99]/10 p-4 sm:items-center sm:p-6">
            <div>
              <Dialog.Title className="text-lg font-bold text-white sm:text-2xl">
                My Orders
              </Dialog.Title>
              <p className="mt-1 max-w-[230px] text-xs text-gray-400 sm:max-w-none sm:text-sm">
                        ...
                        <div className="w-full bg-transparent px-0 py-3 sm:px-2 sm:py-6 md:px-8">
                          <div className="mx-auto flex max-w-6xl flex-col gap-4 md:flex-row md:gap-6">
                            ...
                            <div className="flex w-full min-w-0 flex-col gap-4 md:w-3/4 md:gap-6">
                              <div className="overflow-hidden rounded-2xl border border-white/5 bg-black/20 px-2 py-3 shadow-lg backdrop-blur-sm sm:py-4 md:px-6">
