...
const Usage = ({ activeReq, collateralVal }: UsageProps) => {
  ...
  return (
    <div id="usage-card" className="w-full min-w-0 overflow-hidden rounded-xl border border-[#00ff99]/30 bg-black/40 backdrop-blur-md py-6 transition-all hover:border-[#00ff99]/40">
      <div className="mb-2 px-3 sm:px-4 text-lg sm:px-6 sm:text-xl">
        <h3>Your Usage</h3>
      </div>
      <div className="mb-6 flex flex-col gap-1 border-y border-[#00ff99]/30 p-2 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between">
        <h4 className="p-1">
      ...
      {totalBorrowed > 0 && (
        <div className="mb-2 px-3 sm:px-4">
          <div className="max-h-40 overflow-auto kaleido-scrollbar">
            <table className="min-w-[420px] text-center text-xs sm:min-w-full sm:text-sm">
              <thead></thead>
              <tbody>
