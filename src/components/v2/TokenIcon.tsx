...
const RASTER: Record<string, string> = {
  ...
  ACTOR: "/tokens/actor.webp",
  ARCANINE: "/tokens/arcanine.webp",
  ARCAT: "/tokens/arcat.png",
  ARCHITECTS: "/tokens/architects.webp",
  ARGUS: "/tokens/argus.png",
  AROS: "/tokens/aros.webp",
  BANCOR: "/tokens/bancor.webp",
  BARC: "/tokens/barc.webp",
  BEAN: "/tokens/bean.webp",
  BEANCAT: "/tokens/beancat.jpg",
  CIRBTC: "/tokens/cirbtc.png",
  COOL: "/tokens/cool.png",
  CRCL: "/tokens/crcl.webp",
  CREO: "/tokens/creo.webp",
  LIFT: "/tokens/lift.jpg",
  LONG: "/tokens/long.png",
  MINARA: "/tokens/minara.webp",
  PCH: "/tokens/pch.webp",
  PEG: "/tokens/peg.webp",
  PI: "/tokens/pi.webp",
  TOLLY: "/tokens/tolly.png",
  XNAN: "/tokens/xnan.webp",
};
