...
export const Header = () => {
  ...
  useEffect(() => {
    if (activeAccount?.address) {
      ...
      console.log(
        "🔑 Updated current user address for notifications:",
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-4 lg:flex-nowrap">
        ...
        {/* Mobile Menu Button */}
        <button
          className="ml-auto block text-white focus:outline-none lg:hidden"
          onClick={toggleMenu}
        >
          {isMenuOpen ? (
            <svg
        ...
        <nav className="fixedText hidden flex-1 items-center justify-center space-x-6 font-[family-name:var(--font-zenDots)] text-sm font-medium lg:flex">
          ...
          <Link href="/swap" className={isActive("/swap")}>
            Trade
          </Link>
          <Link href="/pool" className={isActive("/pool")}>
            Liquidity
          </Link>
          <Link href="/stable" className={isActive("/stable")}>
            Stable
          </Link>
          <Link href="/faucet" className={isActive("/faucet")}>
            Faucet
          </Link>
          ...
          <Link
            href="/leaderboard"
            className={`${isActive("/leaderboard")} flex items-center gap-1`}
          >
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          ...
          <Dropdown
            trigger={
              <button
                className="flex min-h-10 min-w-10 items-center justify-center rounded-full text-white transition-colors hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#00ff99]/60"
            ...
            side="bottom"
            align="end"
            contentClassName="w-[calc(100vw-1.5rem)] max-w-[22rem] p-2 sm:p-3"
          >
