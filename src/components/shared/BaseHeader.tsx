  ...
  if (!isClient) {
    return (
      <header className="w-full rounded-lg border border-[#1a9443]/20 bg-black sm:px-10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex w-full min-w-0 flex-col items-start justify-between p-4 lg:flex-row lg:items-center lg:p-0">
          <div className="w-full min-w-0 text-start lg:w-2/3">
            <h3 className="break-words text-2xl font-bold sm:text-3xl lg:text-[40px]">{title}</h3>
            <p className="mt-2 max-w-full break-words text-sm text-white/80 sm:text-base lg:text-[15px]">
              {description}
            </p>
          </div>
          ...
          {showStats && (
            <div className="relative z-10 grid w-full min-w-0 grid-cols-2 gap-3 sm:gap-4 lg:flex lg:items-center lg:gap-12 lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 bg-gradient-to-r from-black/20 via-black/30 to-black/20 backdrop-blur-md border border-[#00ff99]/60 rounded-2xl p-3 sm:p-4 lg:px-10 lg:py-8 shadow-2xl transition-all duration-300 hover:bg-gradient-to-r hover:from-black/30 hover:via-black/40 hover:to-black/30 hover:border-[#00ff99]/80 hover:shadow-3xl lg:hover:scale-105 hover:shadow-[#00ff99]/20 justify-items-center w-full lg:w-auto">
              ...
              <div className="flex flex-col items-center text-center w-full lg:min-w-[80px] group cursor-pointer transition-all duration-300 hover:scale-110 hover:transform relative">
                ...
                <div className="text-white text-base sm:text-2xl text-center break-words font-extrabold font-mono leading-tight transition-all duration-300 group-hover:text-[#00ff99] group-hover:scale-110 group-hover:drop-shadow-lg group-hover:drop-shadow-[#00ff99]/50 relative z-10">
