...
contract QuoterV2 is IQuoterV2, IKaleidoSwapV3SwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IKaleidoSwapV3Pool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IKaleidoSwapV3Pool) {
        return IKaleidoSwapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IKaleidoSwapV3SwapCallback
    function kaleidoswapV3SwapCallback(
        ...
        IKaleidoSwapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IKaleidoSwapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
