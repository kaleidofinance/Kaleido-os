...
import '../../core/interfaces/callback/IKaleidoSwapV3FlashCallback.sol';
...
/// @notice An example contract using the KaleidoSwap V3 flash function
contract PairFlash is IKaleidoSwapV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `kaleidoswapV3FlashCallback`
